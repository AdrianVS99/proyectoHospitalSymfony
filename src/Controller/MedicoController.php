...
{
    #[Route('/mantenimiento', name: 'app_medico_index', methods: ['GET'])]
    ...
    #[Route('/mentenimiento/nuevo', name: 'app_medico_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/medico/{id}', name: 'app_medico_show', methods: ['GET'])]
    ...
    #[Route('/medico/{id}/edit', name: 'app_medico_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/medico/{id}', name: 'app_medico_delete', methods: ['POST'])]
